...
public class MiniLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PROGRAM", "SI", "SINO", "IMPRIME", "MIENTRAS", "PARA", "FUNCION", "RETORNA", 
			"VOID", "INT_T", "BOOL_T", "FLOAT_T", "STRING_T", "TRUE", "FALSE", "AND", 
			"OR", "NOT", "EQ", "NEQ", "LE", "GE", "LT", "GT", "ASIGNA", "SUMA", "RESTA", 
			"MULTI", "DIVIDE", "PARENTESIS_IZQ", "PARENTESIS_DER", "LLAVE_IZQ", "LLAVE_DER", 
			"CORCHETE_IZQ", "CORCHETE_DER", "PUNTO_COMA", "COMA", "INT", "FLOAT", 
