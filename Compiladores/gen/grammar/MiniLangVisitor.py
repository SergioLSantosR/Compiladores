...
class MiniLangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MiniLangParser#funcion.
    ...
    # Visit a parse tree produced by MiniLangParser#tipoRetorno.
    def visitTipoRetorno(self, ctx:MiniLangParser.TipoRetornoContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MiniLangParser#mientras.
    def visitMientras(self, ctx:MiniLangParser.MientrasContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniLangParser#para.
    def visitPara(self, ctx:MiniLangParser.ParaContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniLangParser#paraInicio.
    def visitParaInicio(self, ctx:MiniLangParser.ParaInicioContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniLangParser#paraActualizacion.
    ...
    # Visit a parse tree produced by MiniLangParser#llamadaFuncionStmt.
